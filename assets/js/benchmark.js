...
document.addEventListener("mouseleave", function () {
  if (!quizEnded && !quizExited) {
    // Controlla se il quiz non è terminato e se non è già stato terminato per uscita del cursore
...
function startQuiz() {
  ...
  shuffle(questions);
  // Procedure che avvengono dopo aver premuto su "Proceed" nel quiz
  nextButton.addEventListener("click", () => {
    ...
    if (selectedAnswer !== null) {
      const correctAnswerIndex = questions[
        ...
        (answer) => answer === questions[currentQuestionIndex].correct
      );
